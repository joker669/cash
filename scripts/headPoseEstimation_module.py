...
def headPoseEstimation(image, face_2d, face_3d, nose_2d, nose_3d):
    ...
    nose_3d_projection, jacobian = cv2.projectPoints(nose_3d, rot_vec, trans_vec, cam_matrix, dist_matrix, cv2.cv2.SOLVEPNP_ITERATIVE)
